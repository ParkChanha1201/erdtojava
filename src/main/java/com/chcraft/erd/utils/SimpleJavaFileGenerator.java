...
@Service
public class SimpleJavaFileGenerator implements JavaFileGenerator{
	private final static String TEMPLATE = "//generated by SimpleJavaFileGenerator\n"
			+"package [PACKAGEPATH];\n\n"
	...
	private String generateFields(Entity entity) {
	...
	private String generateGetterAndSetter(Entity entity) {
		List<Field> fields = entity.getFields();
